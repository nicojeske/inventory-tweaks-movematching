...
public class InvTweaksHandlerShortcuts extends InvTweaksObfuscation {
    ...
    public void loadShortcuts() {
        ...
        int[] hotbarKeys = { Keyboard.KEY_1, Keyboard.KEY_2, Keyboard.KEY_3, Keyboard.KEY_4, Keyboard.KEY_5,
                Keyboard.KEY_6, Keyboard.KEY_7, Keyboard.KEY_8, Keyboard.KEY_9, Keyboard.KEY_NUMPAD1,
                Keyboard.KEY_NUMPAD2, Keyboard.KEY_NUMPAD3, Keyboard.KEY_NUMPAD4, Keyboard.KEY_NUMPAD5,
                Keyboard.KEY_NUMPAD6, Keyboard.KEY_NUMPAD7, Keyboard.KEY_NUMPAD8, Keyboard.KEY_NUMPAD9 };
                                ...
                                case ONE_STACK: {
                                    ...
                                    if (shortcut.fromSection != ContainerSection.CRAFTING_OUT
                                        ...
                                        while (slot.getHasStack() && toIndex != -1 && tries < maxTries) {
                                            success = container.move(
                                                    shortcut.fromSection,
                                                    shortcut.fromIndex,
                                                    shortcut.toSection,
                                                    toIndex);
        ...
        if (!shortcut.forceEmptySlot) {
            ...
            for (Slot slot : container.getSlots(shortcut.toSection)) {
                if (slot.getHasStack()) {
                    ...
                    if (!stack.hasTagCompound() && stack.isItemEqual(shortcut.fromStack)
